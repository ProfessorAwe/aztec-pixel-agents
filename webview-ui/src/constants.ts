...
export const MATRIX_HEAD_COLOR = '#a8dbad';
export const matrixGreenBright = (a: number): string => `rgba(46, 139, 87, ${a})`;
...
export const FUEL_COLOR_OK = '#5bbf6b';
export const FUEL_COLOR_WARN = '#d4a017';
export const FUEL_COLOR_DANGER = '#e8845a';
export const FUEL_COLOR_CRITICAL = '#c75b2a';
export const FUEL_GAUGE_BG = '#1a2e22';
export const TEAM_LEAD_COLOR = '#ffc83a';
export const TEAM_ROLE_COLOR = '#20a6a6';
